...
cfg.add("tangent_sleeve_tolerance", 0.5, "tangent approximation tolerance, multiple of ds")
cfg.add("max_radius_height_ratio", 2., "maximum feature radius for abs maxima (relative to bbox)")
...
cfg.add("anchor_expansion_tol", 0.01, "annulus tolerance for terminal disks (was 0.05)")
